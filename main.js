...
itemToDraw = quick_draw_data_set[random]
document.getElementById('draw').innerHTML = 'Item To be Drawn: ' + itemToDraw;
...
function gotResult(error,results)
{
    ...
    console.log(results);
    document.getElementById('confidence').innerHTML = 'Confidence ' + Math.round(itemToDraw.confidence * 100) + '%';
